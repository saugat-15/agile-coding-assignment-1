 ...
 * This class contains some Property values and appropriate getters and setters for those
 * as well as some concrete methods (generic to all Properties). It also has some abstract methods
 * that an inheriting class can use to specify the particular calculations for services for 
 * that property type
 */
